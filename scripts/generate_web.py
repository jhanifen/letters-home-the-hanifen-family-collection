...
<nav id="topnav">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="#" onclick="showSection('people');return false;">People</a>
...
<section id="people" class="section">
  <div class="container">
    ...
    <div class="section-header">
      ...
      <h2 class="section-title">The People in These Letters</h2>
      <div class="section-rule"></div>
    </div>
  ...
  const scansHtml = scans.length ? `
    <div class="ld-scans">
      ...
      <div class="ld-scan-thumbs">
        ${scans.map((s, i) => `<img class="ld-scan-thumb" src="BobScans/${s.filename}" alt="${escHtml(s.label)}" onclick="showScanFull(this, ${i}, '${letter.id}')" title="${escHtml(s.label)}">`).join('')}
      </div>
...
function showScanFull(thumb, idx, letterId) {
  ...
  container.innerHTML = `<img class="ld-scan-full" src="BobScans/${scan.filename}" alt="${escHtml(scan.label)}" onclick="openLightbox('BobScans/${scan.filename}')">`;
}
